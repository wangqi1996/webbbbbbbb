...
function ViewList($page, $cate, $auth, $date, $tags, $isrewrite = false)
{
	...
	echo "Its name is " , get_class($zbp) , "\n";  
	#echo (new ReflectionMethod(zbp,GetArticleList'))->getFileName();  
    $articles = $zbp->GetArticleList(
        $select,
        $w,
        $order,
	...
	echo "Its name is " , get_class($zbp->template) , "\n";  
    echo (new ReflectionMethod('Template','Display'))->getFileName();  
    $zbp->template->Display();
