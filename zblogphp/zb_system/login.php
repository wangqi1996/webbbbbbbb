...
<head>
    ...
    <link rel="stylesheet" href="css/admin.css?v20180625111" type="text/css" media="screen" />
    <script src="http://localhost/zblogphp/zb_system/script/common.js" type="text/javascript"></script>
    <script src="http://localhost/zblogphp/zb_system/script/md5.js" type="text/javascript"></script>
    <script src="http://localhost/zblogphp/zb_system/script/c_admin_js_add.php" type="text/javascript"></script>
